...
class OpenGLRenderer {
  ...
  renderBloom() {
    ...
    // each frame (the texture we wrote to in our previous render pass).
    gl.activeTexture(gl.TEXTURE0);
    gl.bindTexture(gl.TEXTURE_2D, this.post32Targets[1]); // get texture from previous pass
    ...
    // each frame (the texture we wrote to in our previous render pass).
    gl.activeTexture(gl.TEXTURE0);
    gl.bindTexture(gl.TEXTURE_2D, this.post32Targets[2]); // get blurred high pass
    gl.activeTexture(gl.TEXTURE1);
    gl.bindTexture(gl.TEXTURE_2D, this.post32Targets[0]); // get original image
